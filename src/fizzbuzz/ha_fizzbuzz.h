...
/** @file ha_fizzbuzz.h
  ...
  /storage/fizzbuzz/ha_fizzbuzz.cc.

    @note
  Please read ha_fizzbuzz.cc before reading this file.
  Reminder: The fizzbuzz storage engine implements all methods that are
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.

   @see
  /sql/handler.h and /storage/fizzbuzz/ha_fizzbuzz.cc
*/
...
class ha_fizzbuzz : public handler {
 ...
 public:
   ...
   */
  const char *table_type() const { return "FIZZBUZZ"; }
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_fizzbuzz.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_fizzbuzz.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_fizzbuzz.cc. It's not an obligatory method;
